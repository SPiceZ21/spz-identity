...
local WhitelistedProfileKeys = {
    ...
    ['banner_url'] = true,
    ['level'] = true,
    ['top3_in_class_c'] = true,
    ['top3_in_class_b'] = true,
    ['top3_in_class_a'] = true,
    ['top3_in_class_s'] = true,
    ['last_race_at'] = true,
    ['last_race_track'] = true,
    ['sr_daily_gain'] = true,
    ['sr_daily_loss'] = true,
    ['sr_day_marker'] = true,
    ['login_streak'] = true,
...
local function SaveProfile(source)
    ...
    local success = MySQL.update.await([[
        ...
        profile.top3_count,
        profile.level,
        profile.top3_in_class_c,
        profile.top3_in_class_b,
        profile.top3_in_class_a,
        profile.top3_in_class_s,
        profile.last_race_at,
        profile.last_race_track,
        profile.sr_daily_gain,
        profile.sr_daily_loss,
